...
aliases: []
tags: [電子書or閱讀器, 字型]
Modified: 2023-04-25 21:22
date: 2023-04-08T20:40:49
modified: 2025-07-19T12:23:24
---
...
- 源樣黑體ttc https://github.com/ButTaiwan/genyog-font/tree/master
...
- 京華老宋體-標點符號置中版from郭睿穎 https://www.facebook.com/groups/ereaderfamily/posts/7622270767829691
- 匯文明朝體  (復古字體風，適合中文英文、日文可能會怪怪的) https://zhuanlan.zhihu.com/p/344103391
- 霞鶩緻宋 (CL為舊式印刷版、MN為現代慣用寫法) https://github.com/lxgw/LxgwZhiSong
###  楷體字型
- 霞鶩文楷 https://github.com/lxgw/LxgwWenkaiTC (繁體中文版) https://github.com/lxgw/LxgwWenKai (其他系列)
...
- Rounded Mgen+ (共有 Rounded-L、Rounded、Rounded-X 三種版本，從 L 到 X 的圓角程度由輕到重，每個都有多個字重，p／c／m／n：只有英數字有差異。p 的字形現代，c 針對排版優化，m 跟 n 都是等寬字符，只是 n 有特別設計得適合呈現程式碼。) http://jikasei.me/font/rounded-mgenplus/
- 蜜瓜體 Mamelon（マメロン） https://moji-waku.com/mamelon/index.html
- Humour（ユムール）（舊版蜜瓜體） https://moji-waku.com/humour/
- 
### 獅尾黑體家族
...
- 萌神 手写体(拼音部分消失了當一般手寫體用) https://github.com/MaruTama/Mengshen-pinyin-font/
...
### 偽橫排(直轉橫字體)
偽橫排 源雲明體(Simon Lin自製) https://www.facebook.com/groups/ereaderfamily/posts/8976300795760008/
...
- 一點顏體 https://raw.githubusercontent.com/wordshub/free-font/master/assets/font/中文/刻石录系列/I.顏體.ttf
- [崇羲篆體](https://xiaoxue.iis.sinica.edu.tw/chongxi/files/chongxi_seal.zip) https://xiaoxue.iis.sinica.edu.tw/chongxi/download.htm
- 中華民國教育部標準隸書 https://language.moe.gov.tw/result.aspx?classify_sn=23&subclassify_sn=436&content_sn=49
- LINE Seed JP 偏日文（JP） https://seed.line.me/index_jp.html
- LINE Seed TW 繁體中文 https://seed.line.me/index_tw.html
---
...
- [方正隶变繁体](https://freefonts.top/font/60ab2e585fc5a20d2a62e248) (付費字體) https://www.foundertype.com/index.php/FontInfo/index/id/139?utm_source=fontke
...
- Coming Soon 英文可愛字型 https://fonts.google.com/specimen/Coming+Soon
# 特殊
...
- 精靈文．岩 / Elffont Rock (輸入時，請直接選擇注音文（打漢字顯示不出來是正常的）) https://github.com/justfont/Elffont
- 精靈文・蕨 / Elffont Fern(輸入時，請直接選擇注音文（打漢字顯示不出來是正常的）) https://github.com/justfont/Elffont