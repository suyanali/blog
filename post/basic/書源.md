...
## 圖書館
```
台灣圖書館app有hyread、台灣雲端書庫、udn電子書、華藝電子書、iLib Reader、Kono Libraries、pubu(桃園市立圖書館(計次借閱))、overdrive，我會在下面網站搜尋我要的書有在哪家，再到那個app借書。不過有些書可能各大借書系統都沒有，那也只能購買了。(建議把各家能辦線上借閱證的圖書館證都辦了!)
```
...
pubu飽讀、mybook(有不同方案)、博客來(有不同方案)、kindle(分區)、讀墨(有不同方案)、hami書城、mybook、微信讀書付費無限卡、京東讀書vip、掌閱ireader會員、得到(聽書、看書，有各自vip會員可買)、樂天magazine(日本雜誌飽讀)、kono (多語言雜誌飽讀)、kobo plus(暢讀、暢聽、聽讀暢享)、perlego(外文教科書)、喜馬拉雅(聽書)、帆書(聽書)、鏡好聽(聽書)、豆瓣閱讀......
