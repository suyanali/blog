...
## 圖書館
```台灣圖書館app有hyread、台灣雲端書庫、udn電子書、華藝電子書、iLib Reader、Kono Libraries、pubu(桃園市立圖書館(計次借閱)、新竹縣公共圖書館(計次))、hami(例如台北市、高雄市 等等)、overdrive```
...
- **國資圖iLib Reader**
  - https://ebook.nlpi.edu.tw/#
    有的書國資圖帳號就能直接借了，但有的書僅某個圖書館有授權數(或國資圖的授權數已借滿得排隊)，這時先登入帳號後到個人書房-**註冊館維護**把你有的各縣市圖書館帳號都添加，以後就能方便只登入國資圖帳號下直接按借閱了
...
pubu飽讀、mybook(有不同方案)、博客來(有不同方案)、kindle(分區)、讀墨(有不同方案)、hami書城(有3人共享方案)、mybook、微信讀書付費無限卡、京東讀書vip、掌閱ireader會員、得到(聽書、看書，有各自vip會員可買)、樂天magazine(日本雜誌飽讀)、kono (多語言雜誌飽讀)、kobo plus(暢讀、暢聽、聽讀暢享)、perlego(外文教科書)、喜馬拉雅(聽書)、帆書(聽書)、鏡好聽(聽書)、豆瓣閱讀、QQ閱讀會員、光波24書網 (24Reader)......
...
-  **kobo**: 每日99元書、滿555送111、禮物卡滿額贈送、pchome 的kobo每月6~8號有75折(pchome帳號請不要用快速登入的帳號買)、特定書籍85折、大節日有7x折、偶爾有Kobo Tuesday樂天市場星期二75折(可以用樂天點數不能用kobo儲值點數)。kobo有3個地方可以買書-kobo官網 (要國外刷卡手續費)、樂天市場(台灣刷卡，不用手續費，可line pay所以海外可用)、pchome(台灣刷卡，不用手續費)，記得帳號之間要綁定於同一樂天帳號下，各地方活動方式不同。Stuff Your E-Reader活動有一些英文0元書。
   參考以下連結po文與留言區：
...
-  **bookwalke**r:  常有全館點數33倍或其他倍數回饋(1點=1元)，偶爾有滿額另外點數回饋，特定系列書打折，一些折價券要自己找首頁廣告頁領。巴哈姆特可以用3000巴幣換BW的9折券（滿399元可用）。會員日全館79折，好像是在5-6號，新刊不參與全站折扣。偶爾其他日期會出現全館打折活動。Bookwalker 儘可能湊滿額，有很多 youtuber 的 499 折 50、999 折 100 折價券可以搭配
-  **pubu**: 常態有8x折活動要多翻官網或官方社團的折扣碼，大節日有7x折。偶爾有夜貓活動( 17:00 ~ 08:00)10~12本漫畫、小說、成人漫結帳有73折(有指定code，這3種種類要分開結帳)每晚自己檢查或看官方社團、粉絲團公告。[pubu官方社群](https://www.facebook.com/groups/2054241244709844/)偶爾有社團成員限定優惠或者儲值 10% 優惠，可以先儲值再用 7X折買書。周末99元書、買閱讀器送整年3本75折折扣碼。
   參考： https://www.facebook.com/groups/ereaderfamily/posts/8679570645433026/
...
-  **Hyread**: 每月1日的會員日，滿千回饋50%紅利。週三指定書快閃66。偶爾有指定書特價、指定儲值額度有回饋點數。周年慶時有儲值回饋更多，可以趁周年慶儲值完後跟每月1日的會員日combo。
   參考： https://www.facebook.com/groups/ereaderfamily/posts/7827702540619845/
-  **momoBOOK(舊稱mybook)**: 拿來領免費書(現在為1元書)，現在只能到momo買，可以用momo相關高回饋信用卡刷
...
---
- 基本上書買書/儲值請到**該書城網站(網頁版)**不要在app買，可能會有google/apple稅所以比較貴，或者結帳方便度不如網站或者直接導向要你回網站買。
...
kindle(聽說只剩以前出的書可以?)、pubu(要注意有沒有在書籍詳情寫可abe drm下載，另外套書的詳情頁可能騙你，要點入單本再確認)、google圖書(部分，關於本電子書→匯出選項→可匯出，才能匯出，聽說圖片會被壓縮畫質降低)、koboo(不能下載會註明，突然關閉下載的書會在社群公告)、誠品電子書(部分，商品頁下方【規格】確認商品【檔案匯出格式】是否支援Adobe DRM)、smashwords、leanpub、overdrive、Internet Archive

參考可下載Adobe DRM或無加密書檔的書城
https://www.facebook.com/groups/ereaderfamily/posts/8419564578100302/
...
- 免費資源有：
  ...
  - **hami書城**的各縣市圖書館帳號(例如台北市圖書館、台南市圖書館、新竹市圖書館、新竹縣圖書館、高雄市圖書館)
